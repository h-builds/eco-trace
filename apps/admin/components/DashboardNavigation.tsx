        ...
        return (
          <Link
            ...
            className={`text-sm font-medium transition-colors ${
              isActive
                ? "text-brand-verification-green font-bold"
                : "text-brand-deep-charcoal hover:text-brand-verification-green"
            } focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-verification-green rounded-sm cursor-pointer`}
          >
            {link.name}
          </Link>
        );
    ...
    <div className="bg-surface-card border-b border-surface-border w-full py-3 px-6 shadow-subtle flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            return (
              <div key={step.label} className="flex items-center">
                <Link
                  ...
                  } focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-verification-green focus-visible:ring-offset-2 focus-visible:ring-offset-surface-card cursor-pointer`}
      ...
      <div className="flex items-center gap-3 shrink-0">
        <Link
          ...
          className="text-xs font-medium text-functional-neutral hover:text-brand-deep-charcoal underline underline-offset-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-verification-green rounded-sm cursor-pointer"
        >
        ...
        <Link
          ...
          } focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-verification-green focus-visible:ring-offset-2 focus-visible:ring-offset-surface-card`}
